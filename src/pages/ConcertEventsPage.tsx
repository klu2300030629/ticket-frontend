...
const ConcertEventsPage: React.FC = () => {
    ...
    (async () => {
      ...
      if (res.ok) {
        ...
        const mapped: Event[] = (data || []).map((e: any) => ({
          ...
          category: (e.category || 'concerts') as any,
          date: e.startTime || '',
          time: '',
          venue: e.venue,
          poster: '/logo192.png',
  ...
  const concertEvents = useMemo(() => events.filter(e => (e.category || '').toLowerCase() === 'concerts'), [events]);
...
export default ConcertEventsPage;
